...
# The importance list specifies how important each one is, the higher the number, the more important it is. Negative values mean we want to optimize against it. 
...
RESULTS_BASE_DIR = r"usingasb\Optimization Results"
